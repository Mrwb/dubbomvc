...
public class ${className} implements Serializable {
	...
	private ${column.simpleJavaType} ${column.sqlName};
			</#if>
		</#if>
	</#list>
...
<#macro generateJavaColumns>
	<#list table.columns as column>
		...
		<#if column.sqlName??>
			<#if !idAnddefaultColum?contains(column.sqlName)>
	public void set${column.sqlNameFirstUpper}(${column.simpleJavaType} ${column.columnNameFirstLower}) {
		this.${column.sqlName} = ${column.columnNameFirstLower};
	}
	
	public ${column.simpleJavaType} get${column.sqlNameFirstUpper}() {
