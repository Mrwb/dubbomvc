...
public class ForeignKey {
	...
	public String getColumn(String parentCol) {
		...
		System.out.println("-----/////------/////------/////------/////-----//////-------/////-----/////----");
		System.out.println("------ForeignKey-----getColumn----------");
	...
	//2014-11-11  qiyuchun
	//如果是导入键，只有一个键的情况下是正确的，联合主键报错
	public String getImportKey() {
		// return the associated column given the parent column
		String col = "";
		//是一个整数
		Object  obj = parentColumns.getOrderedValue(0);
		if(obj !=null) {
			col = (String) obj;
		}
	...
	//2014-11-11  qiyuchun
	//如果是导出键，只有一个键的情况下是正确的，联合主键报错
	public String getExportKey() {
		
		String col = "";
		//是一个整数
		Object  obj = columns.getOrderedValue(0);
		if(obj !=null) {
			col = (String) obj;
		}
	...
	public static class ReferenceKey {
		...
		public static void main(String[] args) {
			ReferenceKey rk = fromString("scott.User_Role(userId)");
			System.out.println("schemaName=" + rk.schemaName);
			System.out.println("tableName=" + rk.tableName);
			System.out.println("columnSqlName=" + rk.columnSqlName);
		}
	}
}
