...
public class ListHashtable extends Hashtable {
	...
	public static void main(String[] args) {
		...
		String tableName = "ttt_user";
		ForeignKey tbl = new ForeignKey(parentTable,tableName);
		ListHashtable associatedTables = new ListHashtable();
		
		tbl.addColumn("id", "ttt_user_role_id", 1);
		tbl.addColumn("id", "ttt_user_role_id", 2);
		tbl.addColumn("id", "ttt_user_role_id", 3);
		tbl.addColumn("id", "ttt_user_role_id", 4);
		tbl.addColumn("id", "ttt_user_role_id", 5);
		
		associatedTables.put(tableName, tbl);
		
		
		
		ListHashtable p = new ListHashtable();
		p.put(1, "table1");
		p.put(2, "table1");
		p.put(3, "table1");
		p.put(4, "table1");
