...
public class DatabaseDataTypesUtils {
	...
	/**
	 * 由于不满足需求oracle类型需求而修改  NUMBER-->INTEGER,DOUBLE
	 * qiyuchun  2014-11-06
	 * @param sqlType
	 * @param size
	 * @param decimalDigits
	 * @return
	 */
	public static String getPreferredJavaType(String sqlTypeName, int sqlType, int size, int decimalDigits) {
		if(sqlTypeName!=null && sqlTypeName.equalsIgnoreCase("NUMBER") && sqlType == 3) {
			if(decimalDigits > 0) {
   ...
   static {
      ...
      _preferredJavaTypeForSqlType.put(Types.BIGINT, "java.lang.Long");//LONGVARCHAR
