...
public class GeneratorControl {
	private boolean isOverride = Boolean.parseBoolean(System.getProperty("gg.isOverride","false")); //是否覆盖目标文件,如果存在,默认true 
	private boolean isAppend = false; //no pass
	private boolean ignoreOutput = false;   // 不生成输出文件 
	private boolean isMergeIfExists = true; //no pass
	private String mergeLocation; 
	private String outRoot; //设置输出文件的根目录
	private String outputEncoding; //控制模板生成的文件编码 
	private String sourceFile;  //模板源文件file 
	private String sourceDir;   //模板源文件所在的目录 
	private String sourceFileName;  //模板源文件名 
	private String sourceEncoding; //no pass //? 难道process两次确定sourceEncoding//指定模板文件的编码 
