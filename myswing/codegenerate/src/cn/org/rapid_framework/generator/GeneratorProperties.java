...
/**
 * 读取配置文件的类，配置文件包括数据库连接信息和一些基本的参数配置。
...
//            }
	...
	public static void main(String[] args) {
		...
		System.out.println("****////////////*************///////////*************///////////*******");
		String prop1 = gp.getProperty("outRoot");
		System.out.println(prop1);
		String prop2 = gp.getProperty("jdbc.url");
		System.out.println(prop2);
		gp.setProperty("aaa", "aaabbbccc");
		String aaa = gp.getProperty("aaa");
